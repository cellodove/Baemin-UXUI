...
public class CustomSwipeRefreshLayout extends ViewGroup implements NestedScrollingParent3,
    ...
    private void createProgressView() {
        mCircleView = new CustomCircleImageView(getContext());
        mProgress = new CustomProgressDrawable(getContext());
        mProgress.setStyle(CustomProgressDrawable.DEFAULT);


        //mCircleView.setImageDrawable(mProgress);

        mCircleView.setText("땡겨서 새로고침");
        LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT);
        params.setMargins(50,50,50,50);
        mCircleView.setGravity(Gravity.CENTER);
        mCircleView.setLayoutParams(params);
        mCircleView.setTextSize(15);
        mCircleView.setTextColor(ContextCompat.getColor(getContext(),R.color.black));
        mCircleView.setTypeface(Typeface.DEFAULT_BOLD);
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        mCircleView.measure(MeasureSpec.makeMeasureSpec(mCircleDiameter, MeasureSpec.UNSPECIFIED), MeasureSpec.makeMeasureSpec(mCircleDiameter, MeasureSpec.UNSPECIFIED));
        mCircleViewIndex = -1;
